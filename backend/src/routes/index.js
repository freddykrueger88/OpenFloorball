...
import demoDataRoutes from './demoData.js';
...
import opponentsRoutes from './opponents.js';
import teamRoutes from './teams.js';
import teamSaisonmanagerRoutes from './teamSaisonmanager.js';
...
router.use('/opponents', opponentsRoutes);
router.use('/lines', linesRoutes);
router.use('/teams', teamRoutes);
router.use('/teams/:id/saisonmanager', teamSaisonmanagerRoutes);
